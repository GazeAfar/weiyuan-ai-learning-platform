...
function buildSubjectSystemLines(subject: string) {
  if (subject === '化学') {
    return [
      ...
      '不得使用高中有机推断、复杂氧化还原、电化学、离子方程式、溶度积、物质的量等超纲内容。',
    ];
  }
...
function buildGenerationRules(params: {
  ...
  if (params.subject === '化学') {
    return [
      ...
      '推断范围应控制在初中常见物质和人教版表述内，例如 O2、H2O、CO2、CO、C、Fe、Cu、CaCO3、HCl、H2SO4、NaOH、Ca(OH)2、Na2CO3、CuSO4、FeCl3、BaCl2、AgNO3 等。',
      '重点考查物质性质、检验鉴别、除杂、转化关系、常见气体制取与净化、酸碱盐反应和金属活动性。',
      '答案应列出各未知物名称或化学式，并给出关键化学方程式或判断理由。',
      '基础难度线索应直接、物质数量少；提升难度可有两到三步转化；冲刺难度可以跨酸碱盐、金属、碳氧化物综合，但不得超纲。',
